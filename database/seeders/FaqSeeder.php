...
class FaqSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $faqs = [
            [
                'question' => 'كيف يمكنني البدء في الدراسة على منصة Education؟',
            ...
            [
                ...
                'answer' => 'نوفر لك عدة طرق للدفع والاشتراك لتسهيل العملية، يمكنك الدفع عن طريق زين كاش، البطاقات البنكية، أو استخدام رمز الاشتراك المباشر بكل سهولة وأمان.',
                'sort_order' => 3,
                'is_active' => true,
            ],
            [
